...
This is my strongest infrastructure automation project. It shows how Python can connect to real workflow tools, normalize operational data, classify tickets, and safely plan or apply Jira updates.
...
Public-safe FastAPI demo for mapping role requirements to evidence records and keeping generated claims bounded.

What it demonstrates:

- FastAPI service structure
- deterministic requirement/evidence mapping
- fake demo data loading
- supported / partial / unsupported claim classification
- report generation
- public-data safety boundaries

Why it matters:

This project shows how internal tools can help keep workflow outputs reviewable, evidence-aware, and safer to use.
